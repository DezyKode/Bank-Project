...
@Component({
  ...
  styleUrl: './payout-structure.component.css'
})
export class PayoutStructureComponent {
  ...
  tasks = [
    ...
    { fileNo: 2, fileType: '#CPOT-Varun', priority: '2987689876', status: 'ra@123gmail.com', assignTo: 'Active',inSanction:'2', Sanction:'2', inDisbursed:'2',Disbursement:'2',Rejected:'2',Completed:'2',startDate: '2023-01-01', deadline: '2023-12-31', remark: 'tsdd', selected: false },
    { fileNo: 3, fileType: '#2343-DFG', priority: '3987654321', status: 'na@123gmail.com', assignTo: 'Active',inSanction:'3', Sanction:'3', inDisbursed:'3',Disbursement:'3',Rejected:'3',Completed:'3',startDate: '2023-01-01', deadline: '2023-12-31', remark: 'tsdd', selected: false },
